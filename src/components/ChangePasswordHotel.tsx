...
function ChangePasswordHotel() {
    ...
    const handleNewP = (e: ChangeEvent<HTMLInputElement>) => {
        setNewP(e.target.value)
    }

    const handleReenter = (e: ChangeEvent<HTMLInputElement>) => {
...
export default ChangePasswordHotel;