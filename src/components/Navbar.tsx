          ...
          <ul className="navbar-nav ms-auto py-3">
            <li className="nav-item">
              <NavLink
                ...
                onClick={goToTop}
                className={({ isActive }) =>
                  isActive ? "nav-link active px-3" : "nav-link px-3"
                }
                aria-current="page"
              >
                Home
            ...
            <li
              style={{
                display: localStorage.getItem("role") ? "none" : "block",
              }}
              className="nav-item"
            >
              <NavLink
            ...
            <li
              style={{
                display: localStorage.getItem("role") ? "block" : "none",
              }}
            >
              <NavLink
                to={
                  localStorage.getItem("role") === "hotel"
                    ? "/profile-hotel"
                    : "/profile-customer"
                }
            ...
            <li
              style={{ display: document.cookie ? "block" : "none" }}
              className="nav-item"
            >
